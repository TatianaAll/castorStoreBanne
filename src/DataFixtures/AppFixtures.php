...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $product2->setImage('store_banne_pin_nordique_3x2_5.jpg');
        ...
        $product3->setImage('store_banne_teck_birmanie_5x3_5.jpg');
        ...
        $product4->setImage('store_banne_bambou_eco_2_5x2.jpg');
        ...
        $product5->setImage('store_banne_cedre_canadien_3_5x3.jpg');
        ...
        $product6->setImage('store_banne_acacia_robinia_4x2_5.jpg');
        ...
        $product7->setImage('store_banne_chataignier_francais_3x3.jpg');
        ...
        $product8->setImage('store_banne_frene_thermique_4_5x3.jpg');
        ...
        $product9->setImage('store_banne_meleze_alpes_3_5x2_5.jpg');
        ...
        $product10->setImage('store_banne_douglas_francais_3x2.jpg');
        ...
        $product11->setImage('store_banne_eucalyptus_traite_4x3_5.jpg');
        ...
        $product12->setImage('store_banne_sapin_nord_2_5x2.jpg');
        ...
        $product13->setImage('store_banne_iroko_africain_5x4.jpg');
        ...
        $product14->setImage('store_banne_robinier_francais_3_5x2_8.jpg');
        ...
        $product15->setImage('store_banne_composite_bois_4x3.jpg');
